...
namespace DZ_3
{
    ...
    public struct LinearEqK : IEquatable<LinearEqK>
    {
        ...
        // If you don't need it, you can just remove the region and the ": IEquatable<LinearEqK>" declaration.

        public override bool Equals(object obj)
        {
            if (obj is LinearEqK)
                return Equals((LinearEqK)obj); // use Equals method below
            else
                return false;
        }
